        ...
        {tasks.map(task => (
          <div key={task.id} className="border-b border-gray-300 p-4 flex flex-col sm:flex-row justify-between items-start">
            <div className="flex-grow">
              ...
              <p className="text-sm text-gray-600">Due: {dayjs(task.date).format('YYYY-MM-DD')}</p>
              ...
              <p className="text-sm text-gray-500 mt-1">Time left: {dayjs(task.date).diff(dayjs(), 'day')} days</p>
            </div>
