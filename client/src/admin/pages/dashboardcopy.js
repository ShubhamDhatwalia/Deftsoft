...
function Dashboard() {
  const option = {
    ...
    yAxis: [
      {
        type: "value",
        name: "Revenue", // Y-axis title
        axisLabel: {
          formatter: "{value} L", // Suffix for y-axis values
        },
        splitLine: {
          show: false,
        },
    ...
    series: [
      {
        ...
        showSymbol: false,
        data: [
          20, 60, 50, 40, 60, 40, 95, 50, 70, 80, 90,
          100,
        ],
      },
    ],
    ...
    <>
      ...
      <div className="flex flex-col items-center justify-center mx-4 gap-4">
        <div className="flex justify-around flex-wrap mt-6 gap-5 w-full">
          <div className="card bg-teal-50 p-4 rounded-xl drop-shadow-lg hover:scale-105 transition duration-200 h-36">
          ...
          <div className="card bg-orange-50 p-4 rounded-xl drop-shadow-lg hover:scale-105 transition duration-200 h-36">
            <div className="mb-1 text-center flex justify-between gap-28">
        ...
        <div className="chart w-[40vw] bg-violet-200 p-4 rounded-xl">
