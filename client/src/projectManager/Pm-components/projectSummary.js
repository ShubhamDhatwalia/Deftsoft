...
function ProjectSummary() {
  ...
  return (
    <>
      ...
      <div className="header-row flex w-8/12 border-2 rounded-lg h-1/6 pt-2 bg-orange-200">
      ...
      {ProjectData.map((data,index) => {
        return(
          <React.Fragment key={index}>
            <div 
              className="project-list flex flex-row items-center justify-between w-8/12 border-y border-x rounded-lg bg-orange-100 text-slate-600 transition ease-in-out delay-150 hover:bg-orange-200 hover:cursor-pointer hover:translate-y-1 "
